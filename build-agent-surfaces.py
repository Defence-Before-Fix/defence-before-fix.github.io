...
- Detector specification {v["detector"]}: {c}/raw/DETECTOR-SPEC.md
...
def llms(data: dict) -> str:
    ...
    lines = [
        ...
        f"{data['coined']}. Method specification {data['versions']['method']}, detector specification "
        f"{data['versions']['detector']} and toolchain specification {data['versions']['toolchain']}, published {data['versions']['published']}, "
