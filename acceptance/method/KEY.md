...
| 3.5    | Partial or No      | The rule is permanent and blocking, but the suppression was not a recorded decision; 3.5: "neither does a Rule whose green run depends on a Suppression that no recorded decision covers"                  |
...
A reader who grades 3.5 Yes because the rule fails the build has not applied the clause's opening
